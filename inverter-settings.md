...
| DRM | Disable |
| Neutral to Earth Bonding | Disable |
| BMS-stop | Disable |
| CT ratio | 2000 : 1 |
| ATS Enable | ATS Disable, Status OFF |
| Low Power Mode | Disable |
| Low Noise Mode | Disable |
| MPPT Multi-Point Scanning | Disable |
| PV1_Check_Enable | Disable |
| PV2_Check_Enable | Disable |
